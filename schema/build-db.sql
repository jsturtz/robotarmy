...
('CTU',  TRUE,  5, 0.20, 0.25, 'Academic Writing',                           3, FALSE, 'Reference list missing', 'Each in text reference should have a corresponding reference list entry. The project is missing reference list entries. To learn more about references and how to use APA, please check out this really helpful CTU resource: https://careered.libguides.com/ctu/writing/apa'),
('CTU',  TRUE,  1, 1.00, NULL, 'Originality Verification',                   4, TRUE,  'None', 'My review shows that you have met the academic integrity requirements. Thank you. :-)   If you ever have questions about academic integrity or the school''s policy, please check in with me and/or review the policy you can find here: http://coloradotech.smartcatalogiq.com/current/Catalog/Academic-Affairs/Classroom-Policies/Academic-Honesty-and-Integrity'),
('CTU',  TRUE,  2, 1.00, NULL, 'Originality Verification',                   4, TRUE,  'High No Concern', 'Your work has a fairly high OV percentage.  High OV matches sometimes come from things such as reference list matches or many students using some of the same sources. My review shows you have met the academic integrity requirements because your high matches are not from plagiarism or other types of academic integrity violations. Thank you. :-)   If you ever have questions about academic integrity or the school''s policy, please check in with me and/or review the policy you can find here: http://coloradotech.smartcatalogiq.com/current/Catalog/Academic-Affairs/Classroom-Policies/Academic-Honesty-and-Integrity'),
